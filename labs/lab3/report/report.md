...
1. Используя графический редактор Draw.io, повторила схемы L1, L2, L3. (рис. @fig:001).

![Физические устройства сети с номерами потоков (L1)](image/1.png){#fig:001 width=70%}

![Схема VLAN сети (L2)](image/2.png){#fig:002 width=70%}

![Схема маршрутизации сети (L3)](image/3.png){#fig:003 width=70%}

2. Также повторила таблицы VLAN, IP-адресов и портов подключения оборудования планируемой сети.(рис. @fig:004).
...
![Регламент выделения ip-адресов (для сети класса С)](image/7.png){#fig:007 width=70%}

3. Сделала аналогичный план адресного пространства для сети 172.16.0.0/12 с соответствующими схемами  сети и сопутствующими таблицами VLAN, IP-адресов и портов подключения оборудования.(рис. @fig:008).

![Таблица IP](image/8.png){#fig:008 width=70%}

![Таблица портов](image/9.png){#fig:009 width=70%}

![Физические устройства сети с номерами потоков (L1)](image/10.png){#fig:010 width=70%}

![Схема VLAN сети (L2)](image/11.png){#fig:011 width=70%}

![Схема маршрутизации сети (L3)](image/12.png){#fig:012 width=70%}

4. Сделала аналогичный план адресного пространства для сети  192.168.0.0/16 с соответствующей схемой сети и сопутствующей таблицой IP-адресов. (рис. @fig:013).

![Таблица IP](image/13.png){#fig:013 width=70%}

![Схема маршрутизации сети (L3)](image/14.png){#fig:014 width=70%}
